...
def liked_article():
    ...
    return 'escreva o código para exibir o primeiro item na lista liked_articles'
...
def unliked_article():
    ...
    return 'escreva o código para exibir o primeiro item na lista not-liked_articles'
